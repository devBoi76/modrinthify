...
async function updateNotifs(ignore_last_checked) {
    ...
    let notif_enable = (await browser.storage.sync.get("notif_enable")).notif_enable
    let last_status = (await browser.storage.sync.get(["issue_connecting"])).issue_connecting
...
async function restoreSettings() {
    ...
    let a = await browser.storage.sync.get(["token", "user", "notif_enable", "issue_connecting", "theme", "check_delay"])
