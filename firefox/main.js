...
function main() {
    ...
    if (is_search) {
        ...
        if (is_new_design) {
            ...
            search_query = document.title.split(" - ")[0];
        } else {
            search_query = document
